...
<div id="rightSide">
    ...
    <div class="wrapper">
		...
		out.write("<h4 style='color:gray;'>"+request.getAttribute("error")+"</h4>");
	}
%>
        	...
        	<fieldset>
                <div class="widget">
                    ...
                    <div class="formRow">
                        ...
                        <div class="formRight"><input type="text" value="" class="validate[required,custom[email]]" name="userEmail" id="emailValid" pattern="^[a-z0-9A-Z]+[-|a-z0-9A-Z._]+@([a-z0-9A-Z]+(-[a-z0-9A-Z]+)?\.)+[a-z]{2,}$"
			             title="邮箱格式不匹配"s/></div><div class="clear"></div>
                    </div>
                    <div class="formRow">
