        ...
        <form action="index.html" id="validate" class="form">
            <fieldset>
                ...
                <div class="loginControl">
                    <div class="rememberMe"><input type="checkbox" id="remMe" name="remMe" /><label for="remMe">忘记密码</label></div>
...
<!-- Footer line -->
<div id="footer">
    <div class="wrapper">@bbs论坛所有 <a href="http://www.cssmoban.com/" target="_blank" title="论坛"></a> bbs论坛 <a href="http://www.cssmoban.com/" title="网页模板" target="_blank"></a></div>
</div>
